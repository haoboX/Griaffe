...
<html>
<head>
<title>${user_name}的收藏-GRIAFFE-每天都有新鲜事</title>
<meta name="viewport"
...
<body>
	...
	<div class="register_account">
		<div class="wrap">
			...
			<h4 class="title">${user_name}的收藏 </h4>
			<br></br>
			<c:forEach items="${myFavoritePosts}" var="p">
				<tr
				...
				<tr
					...
					height="300">
						...
						<a href="<%=pageContext.getServletContext().getContextPath() %>/favorite/deletefavorite.action?favorite_post=${p.post_id}&favorite_user=${sessionScope.user.user_id}&user_name=${user_name}">
								取消收藏</a></td>

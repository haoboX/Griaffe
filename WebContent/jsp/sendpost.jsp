...
<body>
	...
	<div class="register_account">
		<div class="wrap">
			<h4 class="title">记录下当前瞬间</h4>
			<form
				action="<%=pageContext.getServletContext().getContextPath()%>/post/add.action"
				method="post" name="postform" enctype="multipart/form-data">
				<div class="col_1_of_2 span_1_of_2">
					<input type="hidden" name="post_user"
						value="${sessionScope.user.user_id }"> <input
						type="hidden" name="post_user_name"
						value="${sessionScope.user.user_name }">

					<div>
						给瞬间配段话吧~<input type="text" name="post_name" required="required">
					</div>
					<div>
						瞬间图片<input type="file" name="file">
					</div>

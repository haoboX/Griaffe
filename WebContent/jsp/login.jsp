...
<html>
<head>
<title>登录-GRIAFFE-每天都有新鲜事</title>
<script
	...
	<div class="login">
		<div class="wrap">
			<div class="col_1_of_login span_1_of_login">
				...
				<h5 class="sub_title">注册须知</h5>
				<p>请仔细阅读下面的协议，只有接受协议才能继续进行注册。

					
				</p>
				<div class="button1">
					<a
						href="<%=pageContext.getServletContext().getContextPath() %>/jsp/addUser.jsp"><input
			...
			<div class="col_1_of_login span_1_of_login">
				<div class="login-title">
					...
					<div class="comments-area">
						...
						<form
							action="<%=pageContext.getServletContext().getContextPath() %>/user/login.action"
							method="post" name="myform" enctype="multipart/form-data">
							<p>
								<font color="red" size="4">${error}</font> <br /> <label>账号</label>
								<input type="text" name="account" placeholder="手机号或邮箱">
							</p>
							<p>
								<label>密码</label> <span>*</span> <input type="password"
									name="user_password" placeholder="密码">
							</p>
							<p>
								<input type="radio" name="user_role" value="0">用户 
								<input type="radio" name="user_role" value="1">管理员
							</p>
							<p id="login-form-remember">
								<label><a
									href="<%=pageContext.getServletContext().getContextPath() %>/jsp/findPassword.jsp"">忘记密码
										? </a></label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label><a
									href="<%=pageContext.getServletContext().getContextPath() %>/jsp/addUser.jsp">
										免费注册</a> </label>
							</p>
							<p>

...
<html>
<head>
<title>找回密码-GRIAFFE-每天都有新鲜事</title>
<meta name="viewport"
...
<body>
	...
	<div class="register_account">
		<div class="wrap">
			...
			<form
				action="<%=pageContext.getServletContext().getContextPath()%>/user/findpassword.action"
				method="post" name="find_password_form"
				...
				<div class="">
					...
					<div>
						<input type="text" name="user_question" placeholder="密保问题"
							required="required" />
					</div>
					<div>
						<input type="text" name="user_answer" placeholder="密保密码"
							required="required" />
					</div>
				</div>
				<div class="button1">
					<input class="grey" type="submit" value="找回" /><br />
				</div>
			</form>
		</div>
	</div>

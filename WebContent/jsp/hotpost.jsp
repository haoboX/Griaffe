...
<html>
<head>
<title>热门-GRIAFFE-每天都有新鲜事</title>
<meta name="viewport"
...
<body>
	...
	<div class="register_account">
		<div class="wrap">
			...
			<c:forEach items="${hotPosts}" var="p">
				<tr
					...
					<td
						...
						href="<%=pageContext.getServletContext().getContextPath()%>/user/otherinformation.action?user_id=${p.post_user}&user_name=${p.post_user_name}">${p.post_user_name}：</a></td>
					<td
						style="font-size: large; text-align: center; vertical-align: middle;"
						width="240"><a class="color9"
				...
				<tr
					style="font-size: large; text-align: center; vertical-align: middle;"
					height="300">
					<td style="font-size: large;text-align:center;vertical-align:middle;" width="480"><img src="/post_image/${p.post_image}" width="960"
							height="720" /></td>
				...
				<tr
					...
					height="300">
						...
						<a href="javascript:praisePost('<%=pageContext.getServletContext().getContextPath() %>/praise/hotpostpraisePost.action?praise_post=${p.post_id}&praise_user=${sessionScope.user.user_id}')">
								赞一下</a></td>
						<td style="font-size: large;text-align:center;vertical-align:middle;" width="240">
						<a href="javascript:praisePost('<%=pageContext.getServletContext().getContextPath() %>/favorite/hotpostaddfavorite.action?favorite_post=${p.post_id}&favorite_user=${sessionScope.user.user_id}')">
								收藏</a></td>		
				</tr>
				<br></br>
				</c:forEach>

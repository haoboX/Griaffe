...
<html>
<head>
<title>用户管理-GRIAFFE-每天都有新鲜事</title>
<meta name="viewport"
			...
			<c:forEach items="${users}" var="u">
				<tr
					...
					<td
						...
						href="<%=pageContext.getServletContext().getContextPath()%>/post/mypost.action?post_user=${u.user_id}">${u.user_name}</a></td>
				...
				<tr
					...
					height="300">
						...
						<a href="<%=pageContext.getServletContext().getContextPath() %>/darkroom/addDarkroom.action?dark_user=${u.user_id}">
								封禁</a></td>
				</tr>
				<br></br>

...
<html>
<head>
<title>${myinformation_user_name}-GRIAFFE-每天都有新鲜事</title>
<meta name="viewport"
...
<body>
	...
	<div class="register_account">
		<div class="wrap">
			<h4 class="title">${myinformation_user_name}的个人主页</h4>
			<font color="red"> ${error }</font>
			<button class="grey">关注</button>
			<font color="red"> ${error}</font>
			<br></br>
			<h4 class="title">一共记录了${myinformation_numOfPosts }个瞬间 </h4>
			<c:forEach items="${myinformation_Posts}" var="p">
				<tr

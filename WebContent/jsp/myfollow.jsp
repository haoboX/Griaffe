...
<html>
<head>
<title>${user_name}的关注-GRIAFFE-每天都有新鲜事</title>
<meta name="viewport"
...
<body>
	...
	<div class="register_account">
		<div class="wrap">
			...
			<h4 class="title">${user_name}的关注 </h4>
			<br></br>
			<c:forEach items="${follows}" var="f">
				<tr
					...
					<td
						...
						href="<%=pageContext.getServletContext().getContextPath()%>/user/otherinformation.action?user_id=${f.follow_user_id}&user_name=${f.follow_user_name}">${f.follow_user_name}</a></td>
				...
				<tr
					...
					height="300">
						...
						<a href="<%=pageContext.getServletContext().getContextPath() %>/follow/deletefollow.action?follow_id=${f.follow_id}&user_id=${f.user_id}&user_name=${user_name}">
								取消关注</a></td>
				</tr>
				<br></br>

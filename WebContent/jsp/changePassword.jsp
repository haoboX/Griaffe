...
<html>
<head>
<title>修改密码-GRIAFFE-每天都有新鲜事</title>
<meta name="viewport"
...
<body>
	...
	<div class="register_account">
		<div class="wrap">
			...
			<form
				action="<%=pageContext.getServletContext().getContextPath()%>/user/changepassword.action"
				method="post" name="myform1" enctype="multipart/form-data">
				<div class="">
					<input type="hidden" name="user_id " value="${user_id }" />
					<div>
						<input type="text" name="new_password1" placeholder="请输入新密码"
							required="required" />
					</div>
					<div>
						<input type="text" name="new_password2" placeholder="确认输入新密码"
							required="required" />
					</div>
				</div>
				<button class="grey">修改</button>
